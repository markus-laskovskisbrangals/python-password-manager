...
with open('migration_log.yaml', 'r') as stream:
...
logger.info('Password manager database migration file')
...
try:
	...
	mysql_config_mysql_user = config.get('database', 'db_user')
...
logger.info('The file is closing')